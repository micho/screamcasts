...
set :keep_releases, 5
set :application,   'screamcasts'
set :repository,    'git@github.com:michokest/screamcasts.git'
...
set :production_database,'screamcasts_production'
...
task :hosted do
  role :web, '174.129.39.70'
  role :app, '174.129.39.70'
  role :db, '174.129.39.70', :primary => true
  set :environment_database, Proc.new { production_database }
  set :dbuser,        'teambox'
  set :dbpass,        '23qgSCWpJl'
  set :user,          'teambox'
  set :password,      '23qgSCWpJl'
  set :runner,        'teambox'
